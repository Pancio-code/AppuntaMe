                          ...
                          child:ElevatedButton.icon(
                            ...
                            onPressed: () async{ 
                              if(_formKey.currentState.validate()) {
                                current_client = new Client(nameController.text.hashCode + numberController.text.hashCode + mailController.text.hashCode + serviziController.text.hashCode + prezzoController.text.hashCode, nameController.text, numberController.text,mailController.text,serviziController.text,prezzoController.text);
                                bool esiste = false;
...
// Alert with multiple and custom buttons
  _onAlertButtonsPressed(context) {
    Alert(
      ...
      desc: "vuoi aggiungerlo alla rubrica?",
      buttons: [
        DialogButton(
